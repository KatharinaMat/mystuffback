...
INSERT INTO mystuff."user" (id, role_id, username, password, email, status) VALUES (default, 1,'admin', '123','admin123', 'A');
INSERT INTO mystuff."user" (id, role_id, username, password, email, status) VALUES (default, 2,'hanna', '321','hanna321', 'A');
INSERT INTO mystuff."user" (id, role_id, username, password, email, status) VALUES (default, 2,'katha', '213','katha213', 'A');
